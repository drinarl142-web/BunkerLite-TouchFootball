...
local L=Instance.new("TextButton")L.Name="SneakyButton"L.Parent=v L.AnchorPoint=Vector2.new(0,1)L.BackgroundColor3=Color3.fromRGB(218,218,218)L.BorderSizePixel=0 L.Font=Enum.Font.ArialBold L.TextSize=12 L.Position=UDim2.new(0.05,0,0.2,0)L.Size=UDim2.new(0.4,0,0.158,0)L.Text="Sneaky Off"L.TextColor3=Color3.fromRGB(255,255,255)
...
local S=Instance.new("TextButton")S.Name="SneakyButton2"S.Parent=d S.AnchorPoint=Vector2.new(0,0.8)S.BackgroundColor3=Color3.fromRGB(255,0,0)S.BorderSizePixel=0 S.Font=Enum.Font.ArialBold S.TextSize=14 S.Position=UDim2.new(0.79,0,0.2,0)S.Size=UDim2.new(0.2,0,0.128,0)S.Text="Sneaky Off"S.TextColor3=Color3.fromRGB(255,255,255)S.Active=true S.Draggable=true
...
L.MouseButton1Click:Connect(function()playClick()ax(not ao)end)
S.MouseButton1Click:Connect(function()playClick()ax(not ao)end)
Y.MouseButton1Click:Connect(function()playClick()ay(not aq)end)
V.MouseButton1Click:Connect(function()playClick()ay(not aq)end)
...
a1.MouseButton1Click:Connect(function()playClick()
    if predictionActive then
        disablePrediction()
    else
        enablePrediction()
...
local function getDeviceName()
    local platform = game:GetService("GuiService"):GetPlatform()
    ...
    elseif platform == Enum.Platform.Windows then
        return "PC"
    elseif platform == Enum.Platform.Mac then
        return "Mac"
    elseif platform == Enum.Platform.XBox then
        return "Xbox"
...
game:GetService("StarterGui"):SetCore("SendNotification", {Title = "Bunker Lite", Text = "Loaded on " .. getDeviceName(), Duration = 3})